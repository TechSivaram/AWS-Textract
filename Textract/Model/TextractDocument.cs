...
namespace TechSivaram.DocScan.Textract.Model
{
    public class TextractDocument
    {
        ...
        public TextractDocument(AnalyzeDocumentResponse response)
        {
            ...
            this.ResponsePages = new List<AnalyzeDocumentResponse>();
        ...
        public List<AnalyzeDocumentResponse> ResponsePages { get; set; }
